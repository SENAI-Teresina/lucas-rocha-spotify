...
import 'detalhes_da_musica.dart'; // Importe a tela de detalhes da música

class DetalhesDoArtistaScreen extends StatefulWidget {
  final Artista artista;

  const DetalhesDoArtistaScreen({super.key, required this.artista});
...
class _DetalhesDoArtistaScreenState extends State<DetalhesDoArtistaScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // Filtrando as músicas associadas ao artista
    List<Musica> musicasDoArtista = musicas.where((musica) => musica.artista == widget.artista).toList();
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Container(
            color: isDarkMode ? Colors.black : Colors.white, // Cor de fundo da tela
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color: isDarkMode ? Colors.grey[800] : Colors.grey[200], // Cor de fundo da moldura
                      ),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  musica.titulo,
                                  style: TextStyle(fontSize: 16, color: isDarkMode ? Colors.white : Colors.blue, decoration: TextDecoration.underline),
                                  textAlign: TextAlign.center,
                                ),
                              ),
                            ],
